...
audiowrite(fullfile(filtered_dir, 'filtered_fir_unstable.wav'), y_fir, fs);
audiowrite(fullfile(filtered_dir, 'filtered_butterworth_unstable.wav'), y_butter, fs);
audiowrite(fullfile(filtered_dir, 'filtered_chebyshev_unstable.wav'), y_cheby, fs);
audiowrite(fullfile(filtered_dir, 'filtered_elliptic_unstable.wav'), y_ellip, fs);
...
% Plot the original noisy signal spectrogram
plot_spectrogram(x, fs, 'Spectrogram: Original Noisy Signal', ...
    fullfile(spectrograms_dir, 'original_spectrogram_unstable.png'), ...
...
saveas(gcf, fullfile(spectrograms_dir, 'combined_spectrograms_unstable.png'));
saveas(gcf, fullfile(spectrograms_dir, 'combined_spectrograms_unstable.fig'));
