...
axis([-1.1 1.1 -1.1 1.1]);
grid on;
saveas(gcf, fullfile('..', 'results', sprintf('pz_butterworth_n%d.png', n_butterworth)));
...
axis([-1.1 1.1 -1.1 1.1]);
grid on;
saveas(gcf, fullfile('..', 'results', sprintf('pz_chebyshev_n%d.png', n_chebyshev)));
...
axis([-1.1 1.1 -1.1 1.1]);
grid on;
saveas(gcf, fullfile('..', 'results', sprintf('pz_elliptic_n%d.png', n_elliptic)));
